    ...
    return (
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white pt-8 sm:pt-16 overflow-hidden w-full max-w-full">
            <div className="text-center space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-12 px-4 sm:px-6 md:px-8 w-full max-w-6xl mx-auto -mt-8 sm:mt-0">
                    {isMobile ? (
                        <h1 className="text-2xl xs:text-3xl font-bold leading-tight wrap-break-word max-w-full fade-in">
                    ...
                    {isMobile ? (
                        <p className="text-sm xs:text-base leading-relaxed wrap-break-word max-w-full slide-up delay-200">
                    ...
                    {isMobile ? (
                        <p className="text-xs xs:text-sm text-gray-300 wrap-break-word max-w-full slide-in-scale delay-400">
