...
export default function Footer() {
    return (
        <motion.footer 
            className="relative bg-gradient-to-t from-gray-900/50 to-transparent backdrop-blur-sm border-t border-white/10 py-6 px-4 sm:px-6 md:px-8 text-white"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
        >
            <LazyVideoOverlay videoSrc="/overlay.mp4" opacity={0.05} />
                ...
                >
                    ...
                    <div className="mb-4">
                        ...
                        <motion.a 
                            ...
                            className="text-base text-blue-400 hover:text-blue-300 transition-colors duration-300 underline"
