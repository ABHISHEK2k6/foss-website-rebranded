...
export default function Footer() {
    ...
    return (
        isMobile ? (
            ...
            <footer className="relative bg-linear-to-t from-gray-900/50 to-transparent backdrop-blur-sm border-t border-white/10 py-6 px-6 text-white overflow-hidden">
                <div className="max-w-4xl mx-auto text-center relative z-10 w-full">
                    <div className="space-y-4">
                        <div className="scroll-footer-fade delay-100">
                            <h2 className="text-xl font-bold mb-1 wrap-break-word">
                                FOSS UCEK
                            </h2>
                            <p className="text-sm text-gray-400 wrap-break-word">
                                University College of Engineering Kariyavattom, Thiruvananthapuram, Kerala
                            </p>
                        </div>

                        {/* Email + Social Media Icons */}
                        <div className="flex flex-col items-center gap-3 scroll-footer-slide delay-200">
                            <a
                                href="mailto:fossucek@gmail.com"
                                className="text-sm text-blue-400 hover:text-blue-300 transition-colors duration-300 underline break-all"
                            >
                                foss@uck.ac.in
                            </a>

                            <div className="flex justify-center space-x-4 scroll-footer-social delay-300">
                                {/* LinkedIn */}
                                <a
                                    href="https://www.linkedin.com/company/foss-ucek/"
                                    className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-3 hover:bg-white/20 transition-all duration-300 hover:scale-110"
                                >
                        ...
                        {/* Divider */}
                        <div className="border-t border-white/20 pt-3 scroll-footer-slide delay-400">
            ...
            <motion.footer
                className="relative bg-linear-to-t from-gray-900/50 to-transparent backdrop-blur-sm border-t border-white/10 py-4 px-4 sm:px-6 md:px-8 text-white"
            ...
            >
                <div className="max-w-5xl mx-auto relative z-10">
                    {/* Main Content: brand+address on the left, email+socials on the right */}
                    <motion.div
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                            <motion.a
                                href="mailto:fossucek@gmail.com"
                                className="text-xs sm:text-sm text-blue-400 hover:text-blue-300 transition-colors duration-300 underline"
                    ...
                    {/* Divider */}
                    <motion.div
                        className="border-t border-white/20 mt-3 pt-2"
                        initial={{ scaleX: 0 }}
